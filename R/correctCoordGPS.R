...
#'
#' @examples
#' UTMcoord = data.frame(X = c( runif(5, min = 9, max = 11), runif(5, min = 8, max = 12),
#'                           runif(5, min = 80, max = 120), runif(5, min = 90, max = 110)),
#'                       Y = c( runif(5, min = 9, max = 11), runif(5, min = 80, max = 120),
...
#'
#' aa=correctCoordGPS(UTMcoord = UTMcoord, CoordRel = CoordRel,
#'                      rangeX = c(0, 100), rangeY = c(0, 100))
#' bb=correctCoordGPS(UTMcoord = UTMcoord, CoordRel = CoordRel,
#'                      rangeX = c(0, 100), rangeY = c(0, 100), RmOutliers = TRUE)
#' \dontrun{correctCoordGPS(UTMcoord = UTMcoord, CoordRel = CoordRel,
