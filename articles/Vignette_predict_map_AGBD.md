...
In our case $`Y`$ stands for the logarithm of plot-level AGBD, while
$`X`$ is the logarithm of a LiDAR metric measurement for the
...
ggplot(dt_plot_val)+ 
  ...
  xlab("Field derived AGBD")+
  ylab("LiDAR derived AGBD")+
