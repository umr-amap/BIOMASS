...
data_Kar = melt(datatot, measure.vars = grep("TreeGirth", colnames(datatot)), 
                variable.name = "stem", 
...
resultMC = AGBmonteCarlo(D=KarnatakaForest$D, 
                         WD=KarnatakaForest$WD, 
                         errWD = KarnatakaForest$sdWD, 
                         HDmodel=HDmodel, 
                         Dpropag ="chave2004")

resultMCB = AGBmonteCarlo(D=KarnatakaForestB$D, 
