...
- `sdWD` (g/cm^3): Standard deviation of the wood density that can be
  ...
  [sd_10](https://umr-amap.github.io/BIOMASS/dev/reference/sd_10.md) and
...
using the
[sd_10](https://umr-amap.github.io/BIOMASS/dev/reference/sd_10.md)
dataset.
...
[wdData](https://umr-amap.github.io/BIOMASS/dev/reference/wdData.md),
[sd_10](https://umr-amap.github.io/BIOMASS/dev/reference/sd_10.md)
