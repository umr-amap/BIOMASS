...
test_that("correct coord GPS in UTM", {
  ...
  expect_message(correctCoordGPS(UTMcoord = UTMcoord, CoordRel = CoordRel, rangeX = c(0,100), rangeY = c(0, 100)), 
  ...
  expect_message(correctCoordGPS(UTMcoord = UTMcoord, CoordRel = CoordRel, rangeX = c(0,100), rangeY = c(0, 100), MaxDist = 15), 
                 "Be carefull, you may have GNSS measurement outlayers")
  corr = suppressMessages(
...
test_that("correct coord GPS in long lat", {
  ...
  # whith max dist equal 10
  expect_message(correctCoordGPS(longlat = longlat, CoordRel = CoordRel, rangeX = c(0,100), rangeY = c(0, 100)), 
                 "Be carefull, you may have GNSS measurement outlayers")
  corr = suppressMessages(
  ...
  # with max dist equal 15
  expect_message(correctCoordGPS(longlat = longlat, CoordRel = CoordRel, rangeX = c(0,100), rangeY = c(0, 100), MaxDist = 15), 
                 "Be carefull, you may have GNSS measurement outlayers")
  corr = suppressMessages(
...
test_that("correct coord GPS error", {
  ...
  expect_error(correctCoordGPS(UTMcoord = UTMcoord, CoordRel = CoordRel, rangeX = 52, rangeY = 53), 
               "length equal to 2")
  expect_error(correctCoordGPS(UTMcoord = UTMcoord, CoordRel = CoordRel, rangeX = c(0,100), rangeY = c(0, 100), MaxDist = c(15,0)),
               "one double")
  expect_error(correctCoordGPS(UTMcoord = UTMcoord, CoordRel = CoordRel, rangeX = c(0,40), rangeY = c(0, 40)),
               "The coordRel must be inside the range")
  expect_error(correctCoordGPS(UTMcoord = UTMcoord, CoordRel = rbind(CoordRel, c(40, 40)), rangeX = c(0,100), rangeY = c(0, 100)),
               "same dimension")
  
  expect_error(correctCoordGPS(longlat = c(15,12), UTMcoord = UTMcoord), 
               "too much arguments")
