...
This is done with the `correctTaxo()` function:
...
When the function is called for the first time, a temporary file containing the request to TNRS will be created. Once this has been done, the use of `useCache = TRUE` will access the saved temporary file in order to avoid time-consuming replication of server requests.
