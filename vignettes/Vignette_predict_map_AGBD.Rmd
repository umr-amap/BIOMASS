...
model_cal <- calibrate_model(long_AGB_simu = dt_inf, nb_rep = 50, useCache = T,
                            plot_model = TRUE, chains = 4, thin = 20, iter = 3000,
                            warmup = 500, cores = 4)
```
...
terra::plot(map_agbd$post_median_AGBD, main = "Median of posterior\nAGBD distributions")
terra::plot(map_agbd$post_sd_AGBD, main = "Sd of posterior\nAGBD distributions")
terra::plot(map_agbd$post_sd_AGBD/map_agbd$post_median_AGBD, main = "CV of posterior\nAGBD distributions")
```
