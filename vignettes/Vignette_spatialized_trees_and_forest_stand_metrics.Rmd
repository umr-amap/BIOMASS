...
subplot_AGBD <- subplot_summary(
  ...
  AGB_simu = error_prop$AGB_simu[NouraguesTrees$Plot==201,] # error_prop has been created in the previous vignette
)
```
...
subplot_metric <- subplot_summary(
  ...
  AGB_simu = error_prop$AGB_simu[NouraguesTrees$Plot==201,], 
