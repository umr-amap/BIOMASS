...
```{r divide_plot_trees}
trees <- dplyr::relocate(trees, xRel, yRel, .before = everything()) # to get the coordinates at the first two columns 
...
multiple_trees <- rbind(trees, mutate(trees, plot="NB2"))
