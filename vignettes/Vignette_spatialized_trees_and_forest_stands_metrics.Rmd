...
```{r}
corner_coord <- read.csv(system.file("extdata", "Coord.csv",package = "BIOMASS", mustWork = TRUE))
...
```{r}
trees <- read.csv(system.file("extdata", "NouraguesPlot.csv",package = "BIOMASS", mustWork = TRUE))
