...
```{r}
# toto <- check_plot_trust_GPS$polygon$geometry
# sf::st_set_crs(x = toto, value = check_plot_trust_GPS$UTM_code) # ne fonctionne pas !
# sf::st_write(toto, "../../Documents/NOURAGUES/toto.shp", layer_options = "GEOMETRY=AS_XY")
# sf::st_write(check_plot_trust_GPS$polygon$geometry, "your_directory/plot201.shp", layer_options = "GEOMETRY=AS_XY")
...
subplot_metric <- subplot_summary(subplots = subplots,
                                  value = "D") # AGB is the tree metric
```
...
Of course, the function can handle as many plots as supplied in divide_plot() :
