...
```{r}
trees <- read.csv(system.file("extdata", "NouraguesPlot.csv",
...
coord <- read.csv(system.file("extdata", "Coord.csv",
  package = "BIOMASS", mustWork = TRUE
))
...
AGB <- summaryByPlot(AGB_val = trees$AGB,plot =  trees$subplot, drawPlot = TRUE, subplot = subplot)
print(AGB)
```
